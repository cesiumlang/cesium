...
namespace ConsoleColors {
  ...
  const std::string orange_text = "\033[38;5;208m";  // For debug messages
  const std::string purple_text = "\033[38;5;93m";   // For debuglow messages
  const std::string gray_text = "\033[90m";          // For debuglow2 messages
}
