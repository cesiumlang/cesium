...
MessageType Logger::resolveLogLevel(const std::string& level_name) {
  ...
  if (lower_name == "warning") return MessageType::Warning;
  if (lower_name == "stderr") return MessageType::Stderr;
  if (lower_name == "reserved") return MessageType::Reserved;
  ...
  if (lower_name == "default" || lower_name == "notset") return MessageType::Default;
